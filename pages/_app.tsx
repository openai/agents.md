...
export default function App({ Component, pageProps }: AppProps) {
  return <>
    <Head>
      ...
      <meta name="description" content="AGENTS.md is a simple, open format for guiding coding agents, used by over 30k open-source projects. Think of it as a README for agents." />
